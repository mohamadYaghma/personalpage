...
export default function ProductForm({
  ...
  isLoading,
  selectedCategory,
  handleImageUpload, // تغییر نام از setSelectedImage به handleImageUpload
}) {
  return (
      ...
      <form className="space-y-6" onSubmit={onSubmit}>
        ...
        <div className="flex flex-col">
          ...
          <input
            ...
            id="file"
            name="imageLink"
            onChange={handleImageUpload} // استفاده از handleImageUpload
        ...
        <div className="flex justify-center">
          {isLoading ? (
            ...
            <button
              ...
              className="w-full py-2 px-4 rounded-lg shadow-md text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
              type="submit"
            >
              ارسال
            </button>
